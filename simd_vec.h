...
// ERROR CODES
typedef size_t simd_ret_t;

static const simd_ret_t SIMD_VEC_OK = 0;
static const simd_ret_t SIMD_VEC_ERR_NO_MEM = 1;
static const simd_ret_t SIMD_VEC_ERR_INVALID_ARG = 3;
static const simd_ret_t SIMD_VEC_ERR_NOT_IMPLEMENTED = 4;
static const simd_ret_t SIMD_VEC_ERR_MAX_CAPACITY = 5;
static const simd_ret_t SIMD_VEC_ERR_INVALID_IDX = 6;
...
simd_ret_t simd_vec_new(simd_vec_t*, size_t cap);
void simd_vec_free(const simd_vec_t* vec);
void simd_vec_zero(simd_vec_t*);
simd_ret_t simd_vec_append(simd_vec_t*,float);
simd_ret_t simd_vec_insert_at(simd_vec_t*, size_t, float);
